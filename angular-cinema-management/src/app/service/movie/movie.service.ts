...
export class MovieService {
  ...
  private API_URL_GET_ALL_MOVIE =
    "http://localhost:8080/api/public/movie/list-movie-by-date-show-time";
  ...
  getMovieStatisticListPaging(
    page: number,
    nameMovie: string,
    statusSort: string
  ): Observable<any> {
    return this.httpClient.get<GetReponse>(
      "http://localhost:8080" +
        "/api/admin/movie-statistic-list?page=" +
        page +
        "&nameMovie=" +
        nameMovie +
        "&statusSort=" +
